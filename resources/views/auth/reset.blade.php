...
<div class="glass-card rounded-2xl p-8 w-full max-w-md text-white">
    <div class="text-center mb-8">
        ...
        <p class="opacity-80 mt-2 text-sm">Buat password baru untuk akun Anda</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.update') }}">
        ...
        <div class="mb-6">
            <label class="block mb-2 text-sm font-medium">Password Baru</label>
        ...
        <button type="submit" class="w-full bg-white text-purple-700 py-3 rounded-lg font-semibold hover:bg-opacity-90 transition duration-300">
            Reset Password
        </button>
    </form>
</div>
