...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>PT. [Nama Perusahaan Anda]</p> {{-- Pastikan Anda mengganti ini dengan nama perusahaan yang sebenarnya --}}
      <p>Di Tempat</p><br>

      <p>Dengan hormat,</p>
      <p>Saya yang bertanda tangan di bawah ini:</p>
      <p><strong>Nama Lengkap</strong>: {{ $name ?? 'Tidak Ada Data' }}</p> {{-- Ubah 'Nama' menjadi 'Nama Lengkap' untuk konsistensi --}}
      ...
      <p><strong>Kategori Keluhan</strong>: {{ $complaint_category ?? 'Tidak Ada Data' }}</p> {{-- Ubah complaintCategory menjadi complaint_category --}}
      <p><strong>Deskripsi</strong>: {{ $complaint_description ?? 'Tidak Ada Data' }}</p> {{-- Ubah complaintDescription menjadi complaint_description --}}
