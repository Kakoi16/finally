    ...
    <div class="p-8 bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <div class="mt-6">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-lg font-semibold text-gray-700">Contents</h2>
                <div class="relative">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            @else
                                                ...
                                                @endphp
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 {{ $iconColor }} mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end space-x-3">
                                            @if($file['type'] === 'folder')
                                                <a href="#" class="text-blue-600 hover:text-blue-800" title="Open">
                                            ...
                                            @endif
                                            <a href="#" class="text-gray-500 hover:text-gray-700" title="Download">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
